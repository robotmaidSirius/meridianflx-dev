 ...
 * @note MIT LICENSE
 */
#ifndef __MERIDIAN_MODULE_MRD_SERVO_HPP__
#define __MERIDIAN_MODULE_MRD_SERVO_HPP__
// ヘッダファイルの読み込み
#include "mrd_modules/common.hpp"
#include "mrd_modules/servo/sv_ics.hpp"
...
bool mrd_servo_begin(int a_servo_type, IcsHardSerialClass &a_servo) {
  switch (a_servo_type) {
  case 1:
    // single PWM [WIP]
    return false;
...
bool mrd_servos_drive_lite(MeridimUnion &a_meridim, int a_L_type, int a_R_type,
...
bool mrd_servo_all_off(MeridimUnion &a_meridim) {
...
#endif // __MERIDIAN_MODULE_MRD_SERVO_HPP__
