 ...
 * @note MIT LICENSE
 */
#ifndef __MERIDIAN_MODULE_MRD_BT_PAD_HPP__
#define __MERIDIAN_MODULE_MRD_BT_PAD_HPP__
// ヘッダファイルの読み込み
...
bool mrd_meriput90_pad(MeridimUnion &a_meridim, PadUnion a_pad_array, bool a_marge) {
...
#endif // __MERIDIAN_MODULE_MRD_BT_PAD_HPP__
