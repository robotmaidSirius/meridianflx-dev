...
def create_settings_file(root_dir=""):
    ...
    file_path = os.path.abspath(os.path.join(folder_path, "meridian_plugin_settings.hpp"))
    ...
    with open(file_path, "w", encoding='utf-8') as file:
        file.write('#ifndef __MERIDIAN_PLUGIN_SETTINGS_HPP__\n')
        file.write('#define __MERIDIAN_PLUGIN_SETTINGS_HPP__\n\n')

        file.write('#ifndef SETTING_DEFAULT_DELAY_TIME_MS\n')
        file.write('/// @brief ループ時のデフォルト待機時間（ミリ秒単位）\n')
        file.write('#define SETTING_DEFAULT_DELAY_TIME_MS (10)\n')
        file.write('#endif\n')

        file.write('\n#endif // __MERIDIAN_PLUGIN_SETTINGS_HPP__\n')
