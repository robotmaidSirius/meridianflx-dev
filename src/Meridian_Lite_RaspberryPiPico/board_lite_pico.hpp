/**
 * @file board_lite_pico.hpp
 * @brief Meridian LITE [Board: Raspberry Pi Pico]のボード設定ファイル
 * @version 0.1.0
 * @date 2025-11-24
...
class BoardSetting : public board::MeridianBoardLiteForPico {
private:
  meridian::TestApp app;
  communication::MrdDiagnosticUart *diag_uart = new communication::MrdDiagnosticUart(&Serial);
...
protected:
  ...
  bool init() override {
    ...
    // ボード設定
    //////////////////////////////////////////////////////////
    this->push_communication(this->diag_uart);
