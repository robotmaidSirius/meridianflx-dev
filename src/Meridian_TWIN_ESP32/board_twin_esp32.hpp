/**
 * @file board_twin_esp32.hpp
 * @brief Meridian TWIN [Board: ESP32]のボード設定ファイル
 * @version 0.1.0
 * @date 2025-11-24
 * @copyright Copyright (c) 2025 by Meridian Team. All rights reserved.
 * @note MIT LICENSE
 */
#ifndef __BOARD_TWIN_ESP32_HPP__
#define __BOARD_TWIN_ESP32_HPP__
#include "app_twin_esp32.hpp"
...
class BoardSetting : public board::MeridianBoardTwinForEsp32 {
private:
...
#endif // __BOARD_TWIN_ESP32_HPP__
