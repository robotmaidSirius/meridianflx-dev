 ...
 * @note MIT LICENSE
 */
#ifndef __MERIDIAN_BOARD_MERIDIAN_BOARD_ATOMLITE_HPP__
#define __MERIDIAN_BOARD_MERIDIAN_BOARD_ATOMLITE_HPP__
#include <Arduino.h>
...
#endif // __MERIDIAN_BOARD_MERIDIAN_BOARD_ATOMLITE_HPP__
