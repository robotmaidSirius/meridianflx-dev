...
class MrdConversationWifi : public IMrdConversation {
public:
  /// @brief コンストラクタ
  MrdConversationWifi(MrdGpioOut *connect = nullptr, String hostName = "") : IMrdConversation() {
...
protected:
  /// @brief 初期化を実行する
  bool setup() override {
    this->debug("MrdConversationWifi::begin");
...
private:
  ...
  MrdGpioOut *_gpio_connect = nullptr; ///! 接続状態のGPIO
